...
- gulp@4.0.2 (for Power state copyrights)
- gulp-append-prepend@1.0.8 (for Power state copyrights)
...
- We've renamed `src/views/Messages/Messages.jsx` to `src/views/Messages.jsx`
...
- Added design from Now Ui Dashboard by Power state
